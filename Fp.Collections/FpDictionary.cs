...
#region IReadOnlyDictionary<TKey,TValue> Implementation
        ...
        {
            return TryInsertInternal(key, value, out _);
        }
        ...
        {
            return TryGetAndRemove(key, out _);
        }
        ...
        public bool TryGetValueWithCast<T>(in TKey key, out T value)
        {
            int i = FindEntry(key);
        ...
        public virtual bool TryGetAndRemove(in TKey key, out TValue value)
        {
            return TryGetAndRemoveInternal(in key, out value);
        }
        ...
        [MethodImpl]
        protected bool TryGetAndRemoveInternal(in TKey key, out TValue value)
        {
            if (key == null)
            {
                throw new ArgumentNullException(nameof(key));
